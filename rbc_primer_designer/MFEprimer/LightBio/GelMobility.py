...
# Author: Hellingbin Qu [quwubin@gmail.com], BIRM, China
# Date: 2009-10-12
# License: GPL v3
...
def main ():
    ...
    num = 0
    while min > 50:
        min, max = get_size_range(size, gel_conc=1.0, ref_mobility=50, offset=2, formula='Helling')
        num = num + 1
        print '%s: %s-%s' % (num, min, max)
        size = min
